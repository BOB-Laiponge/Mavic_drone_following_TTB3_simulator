...
class MyPlannerNode(Node):
    def __init__(self):
        ...
        #self.subscription_1 = message_filters.create_subscription(PointStamped, '/gps/gps',self.pos_received, 10) 
        self.subscription_1 = message_filters.Subscriber(self, PointStamped, 'gps/gps')
        #self.subscription_1
        #self.subscription_2 = message_filters.create_subscription(Imu, '/inertial_unit',self.ori_received, 10)
        self.subscription_2 = message_filters.Subscriber(self, Imu, 'inertial_unit')
        #self.subscription_2
        self.subscription_3 = message_filters.Subscriber(self, PointStamped, 'gps/speed')
        #self.subscription_3

        #self.subscription_4 = message_filters.Subscriber(self, PointStamped, 'next_pose')
        self.next_pose=PointStamped()
        self.create_subscription(PointStamped, 'next_pose', self.next_pose_callback, 1)

        self.ts = message_filters.TimeSynchronizer([self.subscription_1, self.subscription_2, self.subscription_3], 30)
